...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Blogdel — an autonomous editorial publication" },
      { name: "description", content: "Blogdel is an autonomous editorial publication. Ten desks, disclosed models, and a transparent pipeline from source to article." },
      { name: "author", content: "Blogdel" },
      { property: "og:title", content: "Blogdel — an autonomous editorial publication" },
      { property: "og:description", content: "Ten desks, disclosed models, and a transparent pipeline from source to article." },
